...
<head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{asset('assets/admin/dist/vendors/ti-icons/css/themify-icons.css')}}">
    <link rel="stylesheet" href="{{asset('asset/admin/dist/vendors/base/vendor.bundle.base.css')}}">
    <!-- endinject -->
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="{{asset('assets/admin/dist/images/favicon.png')}}" />
</head>
<body>
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="{{asset('assets/admin/dist/images/logo.svg')}}" class="mr-2" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{asset('assets/admin/dist/images/logo-mini.svg')}}" alt="logo"/></a>
        </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
                        ...
                        <a class="dropdown-item">
                            <div class="item-thumbnail">
                                <img src="{{asset('assets/admin/dist/images/faces/face4.jpg')}}" alt="image" class="profile-pic">
                            </div>
                        ...
                        <a class="dropdown-item">
                            <div class="item-thumbnail">
                                <img src="{{asset('assets/admin/dist/images/faces/face2.jpg')}}" alt="image" class="profile-pic">
                            </div>
                            <div class="item-content flex-grow">
                        ...
                        <a class="dropdown-item">
                            <div class="item-thumbnail">
                                <img src="{{asset('assets/admin/dist/images/faces/face3.jpg')}}" alt="image" class="profile-pic">
                            </div>
                            <div class="item-content flex-grow">
                ...
                <li class="nav-item nav-profile dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                        <img src="{{asset('assets/admin/dist/images/faces/face28.jpg')}}" alt="profile"/>
                    </a>
...
<!-- plugins:js -->
<script src="{{asset('assets/admin/dist/vendors/base/vendor.bundle.base.js')}}"></script>
<!-- endinject -->
<!-- Plugin js for this page-->
<script src="{{asset('assets/admin/dist/vendors/chart.js/Chart.min.js')}}"></script>
<!-- End plugin js for this page-->
<!-- inject:js -->
<script src="{{asset('assets/admin/dist/js/off-canvas.js')}}"></script>
<script src="{{asset('assets/admin/dist/js/hoverable-collapse.js')}}"></script>
<script src="{{asset('assets/admin/dist/js/template.js')}}"></script>
<script src="{{asset('assets/admin/dist/js/todolist.js')}}"></script>
<!-- endinject -->
